    ...
    <div class="container">
        <div class="menu">
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-message menu-active menu-icon-message-active">
                        <a href="report.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Reports</p></a></div>
                    </td>
                </tr>
    ...
    <div class="header-section">
        ...
        <form action="" method="post" class="header-search">
            <div class="search-container">
                ...
                <a href="report.php" class="login-btn btn-secondary btn">Reset</a>
            </div>
        </form>
    </div>
